...
app.use('/api', (0, _expressHttpProxy2.default)('https://hn.algolia.com/api/v1/', {
  ...
  _createClass(News, [{
    ...
    value: function render() {
      var _props$news = this.props.news,
          news = _props$news === undefined ? [] : _props$news;
...
exports.default = {
  loadData: loadData,
  component: (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(News)
};
